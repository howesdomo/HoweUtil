...
namespace Util.Excel
{
    /// <summary>
    /// 2019-9-9 17:22:16
    /// 备份代码, 若实际项目使用了 Util.Excel.Aspose 的, 但使用 ExcelUtils_Aspose 的更新维护时间成本较高, 改用本 Class 来快速修复问题
    /// </summary>
    public class ExcelUtils_Aspose_V_1_0_0_1
    {
        ...
        /// <returns></returns>
        public static DataTable Excel2DataTable(string filePath, int sheetIndex = 0, bool exportColumnName = true, bool skipErrorValue = false)
        {
            try
            {
        ...
        /// <param name="skipErrorValue">忽略转换出现异常的值</param>
        /// <returns></returns>
        public static DataSet Excel2DataSet(string filePath, bool exportColumnName = true, bool skipErrorValue = false)
        {
        ...
        /// <param name="skipErrorValue">忽略转换出现异常的值</param>
        /// <returns></returns>
        public static DataTable Excel2DataTableAsString(string filePath, int sheetIndex = 0, bool exportColumnName = true)
        {
            try
            {
                Aspose.Cells.Workbook workbook = new Aspose.Cells.Workbook(filePath);
        ...
        /// <param name="exportColumnName">将首行的值设置为DataColumn, 默认设置</param>
        /// <returns></returns>
        public static DataSet Excel2DataSetAsString(string filePath, bool exportColumnName = true)
        {
            Aspose.Cells.Workbook workbook = null;
            try
            {
